...
class Server:
    ...
    def get_hyper(self, page: int = 1, page_size: int = 10) -> dict:
        ...
        return {
            ...
            'next_page': page + 1 if n(page, h(length, page_size)) else None,
            'prev_page': page - 1 if has_prev(page) else None,
            'total_pages': h(length, page_size)
            }
